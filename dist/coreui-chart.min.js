...
CoreUI.chart.type.pie={_options:{},_apexOptions:{},_apex:null,_colors:[],_datasets:[],init:function(t,o,e){this._options=$.extend(!0,{},t),this._apexOptions=$.extend(!0,{},o),this._colors=$.extend(!0,{},e)},render:function(t){this._buildApexOptions(),this._options.hasOwnProperty("options")&&CoreUI.chart.utils.isObject(this._options.options)&&this._options.options.debug&&console.log($.extend(!0,{},this._apexOptions)),this._apex=new CoreUI.chart.apex(t,this._apexOptions),this._apex.render()},_buildApexOptions:function(){let e=this,s="pie",a={},t="solid",o=.9,i="#fff";if(this._apexOptions.colors=Object.values(this._colors),this._apexOptions.chart.type="pie",this._options.hasOwnProperty("options")&&CoreUI.chart.utils.isObject(this._options.options)&&this._options.options.hasOwnProperty("style")&&CoreUI.chart.utils.isObject(this._options.options.style)&&(a=this._options.options.style),this._options.hasOwnProperty("datasets")&&CoreUI.chart.utils.isArray(this._options.datasets)&&$.each(this._options.datasets,function(t,o){return CoreUI.chart.utils.isObject(o)&&o.hasOwnProperty("type")&&"string"==typeof o.type&&0<=["pie","donut","radialBar"].indexOf(o.type)?(s=o.type,e._apexOptions.chart.type=o.type,e._apexOptions.series=o.data,!1):void 0}),a.hasOwnProperty("startAngle")&&"number"==typeof a.startAngle&&(a.startAngle<-360?a.startAngle=-360:360<a.startAngle&&(a.startAngle=360),this._apexOptions.plotOptions.pie.startAngle=a.startAngle,this._apexOptions.plotOptions.radialBar.startAngle=a.startAngle),a.hasOwnProperty("endAngle")&&"number"==typeof a.endAngle&&(a.endAngle<-360?a.endAngle=-360:360<a.endAngle&&(a.endAngle=360),this._apexOptions.plotOptions.pie.endAngle=a.endAngle,this._apexOptions.plotOptions.radialBar.endAngle=a.endAngle),a.hasOwnProperty("size")&&"number"==typeof a.size&&(a.size<1?a.size=0:100<a.size&&(a.size=100),this._apexOptions.plotOptions.pie.donut.size=a.size+"%"),a.hasOwnProperty("labelColor")&&"string"==typeof a.labelColor&&(i=a.labelColor),a.hasOwnProperty("gradient")&&!0===a.gradient&&(t="gradient"),a.hasOwnProperty("labels")&&!0===a.labels&&(this._apexOptions.dataLabels.enabled=!0),a.hasOwnProperty("fill")&&"number"==typeof a.fill&&(a.fill<1?a.fill=1:100<a.fill&&(a.fill=100),o=a.fill/100),a.hasOwnProperty("total")&&"object"==typeof a.total&&a.total.hasOwnProperty("label")&&"string"==typeof a.total.label&&""!==a.total.label)if("donut"===s){if(this._apexOptions.plotOptions.pie.donut.labels.show=!0,this._apexOptions.plotOptions.pie.donut.labels.value.show=!0,this._apexOptions.plotOptions.pie.donut.labels.total.show=!0,this._apexOptions.plotOptions.pie.donut.labels.total.showAlways=!0,this._apexOptions.plotOptions.pie.donut.labels.total.label=a.total.label,a.total.hasOwnProperty("color")&&"string"==typeof a.total.color&&(this._apexOptions.plotOptions.pie.donut.labels.total.color=a.total.color,this._apexOptions.plotOptions.pie.donut.labels.value.color=a.total.color),a.total.hasOwnProperty("formatter"))if("function"==typeof a.total.formatter)this._apexOptions.plotOptions.pie.donut.labels.total.formatter=function(t){return a.total.formatter(t.globals.seriesTotals)};else if("string"==typeof a.total.formatter){let o=CoreUI.chart.utils.getFunctionByName(a.total.formatter);"function"==typeof o&&(this._apexOptions.plotOptions.pie.donut.labels.total.formatter=function(t){return o(t.globals.seriesTotals)})}}else if("radialBar"===s&&(this._apexOptions.plotOptions.radialBar.dataLabels.show=!0,this._apexOptions.plotOptions.radialBar.dataLabels.value.show=!0,this._apexOptions.plotOptions.radialBar.dataLabels.total.show=!0,this._apexOptions.plotOptions.radialBar.dataLabels.total.label=a.total.label,a.total.hasOwnProperty("color")&&"string"==typeof a.total.color&&(this._apexOptions.plotOptions.radialBar.dataLabels.total.color=a.total.color,this._apexOptions.plotOptions.radialBar.dataLabels.value.color=a.total.color),a.total.hasOwnProperty("formatter")))if("function"==typeof a.total.formatter)this._apexOptions.plotOptions.radialBar.dataLabels.total.formatter=function(t){return a.total.formatter(t.globals.seriesTotals)};else if("string"==typeof a.total.formatter){let o=CoreUI.chart.utils.getFunctionByName(a.total.formatter);"function"==typeof o&&(this._apexOptions.plotOptions.radialBar.dataLabels.total.formatter=function(t){return o(t.globals.seriesTotals)})}this._apexOptions.fill.type=t,this._apexOptions.fill.gradient.opacityFrom=o,this._apexOptions.fill.gradient.opacityTo=1,this._apexOptions.fill.opacity=o,this._apexOptions.dataLabels.style.colors=[i]}};;
